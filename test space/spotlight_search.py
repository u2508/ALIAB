...
SEND_BUTTON_STYLE = "QPushButton { background-color: aqua; border: 2px solid transparent; border-radius: 5px; }""QPushButton:hover { background-color: lightcyan; }"
...
def reset_button_style():
        send_button.setStyleSheet(
            "QPushButton { background-color: aqua; border: 2px solid transparent; border-radius: 5px; }"
